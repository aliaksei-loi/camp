      ...
      <section className="faq" id="faq" data-screen-label="10 FAQ">
        <div className="faq-inner">
          ...
          <div className="faq-list">
            <Faq
              q="С какого возраста можно приезжать с детьми?"
              a="Минимальный возраст — 2 года, максимальный — не ограничен. У нас есть программы для 3–6, 7–11, 12–16 лет и семейные активности для всех. Малыши до 2 лет — бесплатно."
              open
            />
            <Faq
              q="А если пойдёт дождь?"
              a="Дождь — не повод сворачиваться. У нас есть большой крытый навес, кулинарная юрта, мастерские, настолки и кино-вечер. Часто самые тёплые воспоминания — именно про дождливые дни."
            />
            <Faq
              q="Питание — что едят дети?"
              a="Три приёма пищи + полдник. Готовим сами на большом очаге: каши, супы, овощи с огорода, хлеб из печки, пироги. Учитываем аллергии и вегетарианство — просто укажите при бронировании."
            />
            <Faq
              q="Как добраться?"
              a="Из Минска — трансфер, входит в пакет. Выезжаем в день смены в 10:00 от площади Победы. На машине — 2 часа, координаты пришлём в письме."
            />
            <Faq
              q="Можно ли приехать без детей?"
              a="Можно! У нас есть взрослая линейка активностей — йога, керамика, вечерние разговоры. Но атмосфера у нас семейная, имейте это в виду."
            />
            <Faq
              q="Есть ли wi-fi и связь?"
              a="Мобильная связь работает. Wi-fi — в лаундже, с 18:00 до 22:00. Остальное время мы специально «отключаемся». Это часть опыта."
            />
          </div>
        </div>
      </section>
