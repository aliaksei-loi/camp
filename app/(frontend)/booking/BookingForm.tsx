    ...
    <div className="booking-main">
      <div className="booking-wrap">
          ...
          {submitted ? (
            <div className="thanks">
              ...
              <div className="thanks-meta">
                <div>
                  ...
                  <div className="tm-val">{periodLabel}</div>
                </div>
                <div>
            ...
            <>
              <div className="dates-band">
                ...
                <div style={{ flex: 1 }}>
                  <div className="big">{periodLabel}</div>
                  <div className="sm">{periodSub}</div>
                </div>
              </div>
        ...
        <div className="booking-summary-col">
          ...
          <SumLine lbl="Даты" val={periodLabel} />
          <SumLine lbl="Длительность" val={periodSub} />
