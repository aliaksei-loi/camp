...
const HOME = {
  ...
  pricingHead: {
    eyebrow: "★ пакеты ★",
    titleLine1: "Цены,",
    titleLine2: "от которых не больно.",
    body: "Всё включено, без скрытых платежей: проживание, питание 3 раза в день, программы для детей, вечерние мероприятия, баня, чай с травами.",
  },
  reviewsHead: {
    eyebrow: "★ пишут семьи ★",
